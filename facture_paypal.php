    ...
    <body>
        ...
        <?php include("menus.php"); ?>
            ...
            <main class="mdl-layout__content">
                ...
                <h3 style="font-family: 'Julius Sans One';">Une facture vous a été envoyé par mail.
                <p><a href=""><button class="mdl-button mdl-js-button mdl-button--accent" type="button" name="print">Imprimer</button></a></p></h3></CENTER>
                <div id="facture">
                  ...
                  <div id="pied_de_page">
                      <div class="mdl-card__supporting-text">Reste à payer : 0€ TTC</div>
                      <div class="mdl-card__supporting-text">Paiement effectué le ...</div>
